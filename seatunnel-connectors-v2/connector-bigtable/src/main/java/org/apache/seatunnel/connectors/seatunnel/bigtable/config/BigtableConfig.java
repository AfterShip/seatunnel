...
public class BigtableConfig extends ConfigCenterConfig {
    ...
    public static final Option<String> KEY_ALIAS = Options.key("key_alias")
            .stringType()
            .noDefaultValue()
            .withDescription("Name of the field for row key.");

    public static final Option<String> COLUMN_MAPPINGS = Options.key("column_mappings")
            .stringType()
            .noDefaultValue()
            .withDescription("Mappings from record field to Bigtable column name. "
    ...
    public static final Option<String> BIGTABLE_OPTIONS = Options.key("bigtable_options")
            .stringType()
            .noDefaultValue()
